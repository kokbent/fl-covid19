...
wp <- fread("pseudo-sim/output/wp.csv")
pers <- fread("pseudo-sim/output/person_details.csv")
...
#### Export ----
fwrite(pers1, "pseudo-sim/output/pers_w_wid.csv")
fwrite(wp2, "pseudo-sim/output/wp2.csv")
