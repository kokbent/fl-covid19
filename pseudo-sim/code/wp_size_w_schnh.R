...
source("pseudo-sim/code/target_func.R")
...
## NH
if (file.exists("pseudo-sim/output/nh.csv")) {
...
## SCH
if (file.exists("pseudo-sim/output/sch.csv")) {
...
## HF
if (file.exists("pseudo-sim/output/hf.csv")) {
...
## NAICS
if (file.exists("pseudo-sim/data/naics_emp_wpar.csv")) {
  naics <- fread("pseudo-sim/data/naics_emp_wpar.csv")
...
naics_1712 <- fread("pseudo-sim/data/naics_1712_lookup.csv")
...
fwrite(wp2, "pseudo-sim/output/wp.csv")
