...
#### Data import ----
## PERS
gen_pers <- fread("pseudo-sim/output/person_details.csv")
gen_hh <- fread("pseudo-sim/output/hh_coords.csv")
...
#### Export ----
fwrite(gc_sch3, "pseudo-sim/output/sch.csv")
fwrite(gen_pers, "pseudo-sim/output/person_details.csv")
