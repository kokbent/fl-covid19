...
if (!file.exists("sim_pop-florida-1.1.tgz")) stop("File sim_pop-florida-1.1.sqlite.tgz must be in the same folder as this script.")
untar("sim_pop-florida-1.1.tgz", exdir=".")
