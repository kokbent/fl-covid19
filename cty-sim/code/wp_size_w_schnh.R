...
source("cty-sim/code/target_func.R")
...
## SCH
if (file.exists("cty-sim/output/sch.csv")) {
...
## HF
if (file.exists("cty-sim/output/hf.csv")) {
...
## NAICS
if (file.exists("cty-sim/data/naics_emp_wpar.csv")) {
  naics <- fread("cty-sim/data/naics_emp_wpar.csv")
...
naics_1712 <- fread("cty-sim/data/naics_1712_lookup.csv")
...
fwrite(wp2, "cty-sim/output/wp.csv")
