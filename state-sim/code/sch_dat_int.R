...
#### Data import ----
## PERS
gen_pers <- fread("state-sim/output/person_details.csv")
gen_hh <- fread("state-sim/output/hh_coords.csv")
...
#### Export ----
fwrite(gc_sch3, "state-sim/output/sch.csv")
fwrite(gen_pers, "state-sim/output/person_details.csv")
