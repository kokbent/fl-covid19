...
#### Data import
wp <- read_csv("toy2/output/wp2.csv")
head(wp)
...
pers <- read_csv("toy2/output/pers_w_wid.csv")
head(pers)
...
dir.create("toy2/output/sim_pop-escambia")
mydb <- dbConnect(RSQLite::SQLite(), "toy2/output/sim_pop-escambia/sim_pop-escambia.sqlite")
