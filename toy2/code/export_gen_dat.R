...
dir.create("toy2/sim_pop-escambia-1.1")
mydb <- dbConnect(RSQLite::SQLite(), "toy2/sim_pop-escambia-1.1/sim_pop-escambia-1.1.sqlite")
...
setwd("toy2/")
tar("sim_pop-escambia-1.1.tgz", files = "sim_pop-escambia-1.1/", compression = "gzip")
