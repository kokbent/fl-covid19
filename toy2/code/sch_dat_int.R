...
#### Data import ----
## PERS
gen_pers <- fread("toy2/output/person_details.csv")
gen_hh <- fread("toy2/output/hh_coords.csv")
...
#### Export ----
fwrite(gc_sch3, "toy2/output/sch.csv")
fwrite(gen_pers, "toy2/output/person_details.csv")
