...
if (!file.exists("sim_pop-escambia-1.0.tgz")) stop("File sim_pop-escambia-1.0.tgz must be in the same folder as this script.")
untar("sim_pop-escambia-1.0.tgz", exdir=".")

#### Connect
con <- DBI::dbConnect(RSQLite::SQLite(), "sim_pop-escambia-1.0/sim_pop-escambia-1.0.sqlite")
